        ...
        <div class="space-y-32">
            ...
            <div class="flex flex-col md:flex-row items-center gap-16">
                <div class="w-full text-center max-w-4xl mx-auto">
                    ...
                    <p class="text-lg text-gray-600 leading-relaxed mb-8">
                        Don't just print it — publish it. Students and faculty can access their personalized schedules
                        continuously updated on any mobile device.
                    </p>
                    <div class="flex gap-4 justify-center">
                        <button
                            class="bg-gray-900 text-white px-6 py-3 rounded-xl flex items-center hover:bg-gray-800 transition">
