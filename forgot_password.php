...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->num_rows > 0) {
        ...
        if (file_exists('includes/SimpleSMTP.php') && file_exists('config/mail_config.php')) {
            ...
            // Fallback if SMTP config missing
            file_put_contents("email_log.txt", "To: $email\nSubject: Password Reset\n$emailContent\n\n", FILE_APPEND);
            $message = "<b>Reset Link Generated</b><br>Since SMTP configuration is missing, I saved the reset link to <code>email_log.txt</code>.";
        }
    } else {
    ...
    <div class="max-w-md mx-auto mt-12">
        <div class="card p-10">
            ...
            <form action="forgot_password.php" method="POST">
                <div class="mb-6">
                    <label class="block text-gray-700 font-medium mb-2" for="reset-email">Enter your registered email address</label>
            ...
            <p class="text-center mt-4 text-gray-600">
                Remember your password? <a href="login.php" class="text-purple-600 font-semibold hover:underline">Log in here</a>
            </p>
        </div>
    </div>
</section>
